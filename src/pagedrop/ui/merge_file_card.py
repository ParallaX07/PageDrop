...
from pagedrop.ui.theme import (
    CARD_PADDING,
    CARD_WIDTH,
    merge_file_card_stylesheet,
    shadow_qcolor,
)


class MergeFileCard(QFrame):
    ...
    def __init__(
        ...
        self._thumbnail_label.setObjectName("MergeFileCardThumbnail")
        self._thumbnail_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self._thumbnail_label.setMinimumHeight(80)

        filename = Path(path).name
        self._title_label = QLabel(filename)
        self._title_label.setObjectName("MergeFileCardTitle")
        ...
        self._subtitle_label = QLabel(f"{page_count} {noun}")
        self._subtitle_label.setObjectName("MergeFileCardSubtitle")
